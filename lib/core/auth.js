...
export default class Auth {
  ...
  setUser (user) {
    ...
    // if user endpoint is false we don't care about the user content
    // else we want it to be a non-empty object
    if (typeof user === 'object') {
      loggedIn = /*!this.strategy.options.userinfo_endpoint ||*/ JSON.stringify(user) !== '{}'
    }
